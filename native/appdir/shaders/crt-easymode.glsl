...
#pragma parameter SCANLINE_CUTOFF "Scanline Cutoff" 500.0 1.0 1000.0 1.0
...
// Keen: DOSBox-X reports the double-scanned 640x400 frame for this game's
// EGA modes, so the stock 400-line cutoff disabled scanlines everywhere.
#define SCANLINE_CUTOFF 500.0
